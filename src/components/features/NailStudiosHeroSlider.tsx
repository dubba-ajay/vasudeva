...
const heroSlides = [
  {
    ...
    subtitle: "Creative nail art & designs",
    description: "Professional nail care with artistic flair and premium manicure services",
    ...
    reviews: 1034,
    services: [
      { name: "Nail Art Design", price: "₹850", duration: "75 min" },
      { name: "Gel Extensions", price: "₹1200", duration: "90 min" },
      { name: "Classic Manicure", price: "₹600", duration: "45 min" }
    ],
    stats: { artists: "8+ Expert", bookings: "400+ this month", rating: "4.8/5" },
    specialOffer: "First visit 20% off"
  },
  {
    id: 2,
    title: "Polish Perfect",
    subtitle: "Luxury nail care experience",
    description: "Premium nail treatments with relaxing spa experience and luxury products",
    image: "https://images.unsplash.com/photo-1610992015732-2449b76344bc?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    gradient: "from-teal-600 via-cyan-600 to-blue-700",
    location: "Khan Market, Delhi",
    rating: 4.9,
    reviews: 892,
    services: [
      { name: "Luxury Pedicure", price: "₹1200", duration: "90 min" },
      { name: "Spa Manicure", price: "₹900", duration: "60 min" },
      { name: "Hand Treatment", price: "₹750", duration: "45 min" }
    ],
    stats: { artists: "12+ Master", bookings: "550+ this month", rating: "4.9/5" },
    specialOffer: "Spa package 25% off"
  },
  {
    id: 3,
    title: "Nails & Beyond",
    subtitle: "Modern nail studio",
    description: "Latest nail trends and cutting-edge techniques for contemporary designs",
    image: "https://images.unsplash.com/photo-1619394082667-dc9cf16dff22?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    gradient: "from-rose-600 via-pink-600 to-purple-700",
    location: "Select City Walk, Saket",
    rating: 4.7,
    reviews: 756,
    services: [
      { name: "Trendy Nail Design", price: "₹700", duration: "60 min" },
      { name: "Express Manicure", price: "₹500", duration: "30 min" },
      { name: "Color Matching", price: "₹400", duration: "20 min" }
    ],
    stats: { artists: "6+ Experts", bookings: "350+ this month", rating: "4.7/5" },
    specialOffer: "Weekend special 30% off"
  },
  {
    id: 4,
    title: "Glamour Nails Studio",
    subtitle: "Professional nail artistry",
    description: "Expert nail artists specializing in custom designs and premium nail care",
    image: "https://images.unsplash.com/photo-1604654894610-df63bc536371?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    ...
    reviews: 643,
    services: [
      { name: "Custom Nail Art", price: "₹1000", duration: "90 min" },
      { name: "Professional Styling", price: "₹800", duration: "60 min" },
      { name: "VIP Package", price: "₹2000", duration: "150 min" }
    ],
    stats: { artists: "10+ Experts", bookings: "450+ this month", rating: "4.8/5" },
    specialOffer: "Group booking 15% off"
  }
];

const NailStudiosHeroSlider = () => {
...
export default NailStudiosHeroSlider;
